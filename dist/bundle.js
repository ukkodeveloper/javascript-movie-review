...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ MovieDetailFetcher)\n/* harmony export */ });\n/* harmony import */ var _constants_movieURLs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../constants/movieURLs */ \"./src/constants/movieURLs.ts\");\n/* harmony import */ var _fetchJson__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../fetchJson */ \"./src/domain/fetchJson.ts\");\nvar __classPrivateFieldGet = (undefined && undefined.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar _MovieDetailFetcher_instances, _MovieDetailFetcher_createURL, _MovieDetailFetcher_processMovieData;\n\n\nclass MovieDetailFetcher {\n    constructor(id) {\n        _MovieDetailFetcher_instances.add(this);\n        this.base = `https://api.themoviedb.org/3/movie`;\n        this.params = {\n            api_key: \"c9b417a74f38d67da13a13b782bc5ce3\",\n            language: 'ko-KR',\n        };\n        this.base = `${this.base}/${id}`;\n    }\n    fetchMovie() {\n        return (0,_fetchJson__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(__classPrivateFieldGet(this, _MovieDetailFetcher_instances, \"m\", _MovieDetailFetcher_createURL).call(this, this.params), __classPrivateFieldGet(this, _MovieDetailFetcher_instances, \"m\", _MovieDetailFetcher_processMovieData).bind(this));\n    }\n}\n_MovieDetailFetcher_instances = new WeakSet(), _MovieDetailFetcher_createURL = function _MovieDetailFetcher_createURL(params) {\n    const url = new URL(this.base);\n    Object.entries(params).forEach(([param, value]) => {\n        url.searchParams.append(param, value);\n    });\n    return url.toString();\n}, _MovieDetailFetcher_processMovieData = function _MovieDetailFetcher_processMovieData({ id, title, overview, poster_path, vote_average, genres }) {\n    return {\n        id,\n        title,\n        overview,\n        genres: genres.map(genre => genre.name),\n        posterPath: `${_constants_movieURLs__WEBPACK_IMPORTED_MODULE_0__.MOVIE_IMAGE_URL}/${poster_path}`,\n        voteAverage: vote_average,\n    };\n};\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/fetcher/MovieDetailFetcher.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _constants_movieURLs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../constants/movieURLs */ \"./src/constants/movieURLs.ts\");\n/* harmony import */ var _MovieFetcher__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MovieFetcher */ \"./src/domain/fetcher/MovieFetcher.ts\");\n\n\nclass PopularMovieFetcher extends _MovieFetcher__WEBPACK_IMPORTED_MODULE_1__[\"default\"] {\n    constructor() {\n        super();\n        this.base = _constants_movieURLs__WEBPACK_IMPORTED_MODULE_0__.POPULAR_MOVIE_URL;\n    }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PopularMovieFetcher);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/fetcher/PopularMovieFetcher.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _constants_movieURLs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../constants/movieURLs */ \"./src/constants/movieURLs.ts\");\n/* harmony import */ var _MovieFetcher__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MovieFetcher */ \"./src/domain/fetcher/MovieFetcher.ts\");\n\n\nclass SearchMovieFetcher extends _MovieFetcher__WEBPACK_IMPORTED_MODULE_1__[\"default\"] {\n    constructor(keyword) {\n        super({ query: keyword });\n        this.base = _constants_movieURLs__WEBPACK_IMPORTED_MODULE_0__.SEARCH_MOVIE_URL;\n    }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SearchMovieFetcher);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/fetcher/SearchMovieFetcher.ts?");
